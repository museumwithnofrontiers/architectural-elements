...
// `...defineViewerConfig({ dataPackage: '@museumwnf/architectural-elements-data', plugins: [vue()] })`
  ...
  resolve: {
    alias: {
      ...
      '@inventory-data': fileURLToPath(
        new URL('./node_modules/@museumwnf/architectural-elements-data', import.meta.url),
      ),
    },
  },
  optimizeDeps: {
