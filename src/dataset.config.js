...
const about = {
  body: 'architecturalElements.about.body',
...
export default {
  ...
  home: {
    title: 'architecturalElements.identity.title',
    intro: 'architecturalElements.home.intro',
    cards: [
      {
        title: 'architecturalElements.nav.catalogue',
        description: 'architecturalElements.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'architecturalElements.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'architecturalElements.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'architecturalElements.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //       partnerObjects: {
  //         emptyPartner: 'architecturalElements.partnerObjects.emptyPartner',
  //         emptyInstitution: 'architecturalElements.partnerObjects.emptyInstitution',
  //         institutionSummary: 'architecturalElements.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'architecturalElements.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'architecturalElements.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
