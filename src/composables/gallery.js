...
// legacy project key, no UUID — Architectural Elements shares the same
// entity list and catalogue shape as every other DXA gallery, so there is
// nothing of its own to feed in.
