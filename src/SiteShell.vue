<script setup>
// The Architectural Elements page chrome: the layout's own `SiteShell`,
// composed from `dataset.config.js`'s `navigation` and `banner` (the menu,
// the header and footer link lists, the section-title map, the search box,
// the banner variant/eyebrow/enter). What is left here is what only a loaded
// record can answer — the banner's own image and caption, the home page's
// title — and the MWNF mark in the header.
